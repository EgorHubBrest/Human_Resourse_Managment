    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='Name department',
                                          max_length=50, verbose_name='Department')),
                ('status', models.CharField(choices=[
                 ('Inactive', 'Inactive'), ('Active', 'Active')], default='Inactive', max_length=8)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('name', models.CharField(default='Name Person',
                ...
                ('salary', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal(
                    '0'), default_currency='USD', max_digits=14, verbose_name='Salary')),
                ('email', models.EmailField(default='',
                                            max_length=254, verbose_name='Email')),
                ('status', models.CharField(choices=[
                 ('Inactive', 'Inactive'), ('Inactive', 'Inactive')], default='Inactive', max_length=8)),
                ('department', models.ForeignKey(default='Name department',
                                                 on_delete=django.db.models.deletion.CASCADE, to='department_app.department')),
            ],
            options={
