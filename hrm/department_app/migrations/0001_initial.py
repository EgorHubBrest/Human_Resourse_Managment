...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Department',
            fields=[
                ('name', models.CharField(max_length=50, primary_key=True, serialize=False, verbose_name='Department')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(verbose_name='Date of birthday')),
                ...
                ('salary', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=14, verbose_name='Salary')),
                ('email', models.EmailField(max_length=254, verbose_name='Email')),
                ('status', models.CharField(choices=[('Inactive', 'Inactive'), ('Inactive', 'Inactive')], default='Inactive', max_length=10)),
                ('department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='department_app.department')),
            ],
            options={
